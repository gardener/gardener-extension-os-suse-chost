...
var _ = Describe("Mutate", func() {
	...
	Describe("Reconcile OSC", func() {
		...
		DescribeTable("Setting the cgroup driver depending on cHost version",
			...
			Entry("on cHost 15 SP6 starting with build timestamp 20250918", "15.6.20250918", extensionsv1alpha1.CgroupDriverSystemd, kubeletCgroupDriverSystemd),
			...
			Entry("on cHost 15 SP7 starting with build timestamp 20250825", "15.7.20250825", extensionsv1alpha1.CgroupDriverSystemd, kubeletCgroupDriverSystemd),
