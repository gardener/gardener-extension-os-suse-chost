...
func init() {
	...
	// all SP6 and SP7 builds rung with cgroup v2 but in order to not change the cgroup driver settings
	// on already existing clusters, we introduce the systemd driver with these build numbers only

	cgroupv2cHost15sp6 = semver.MustParse("15.6.20250918")
	cgroupv2cHost15sp7 = semver.MustParse("15.7.20250825")
}
